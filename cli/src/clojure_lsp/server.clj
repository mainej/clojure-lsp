...
(defn run-server! []
  (try
    (let [producer* (atom nil)
          ...
          launcher (Launcher/createLauncher server ClojureLanguageClient is os false (java.io.PrintWriter. (io/writer (io/file "../../integration-test/sample-test/clojure-lsp.lsp-trace.out"))))
